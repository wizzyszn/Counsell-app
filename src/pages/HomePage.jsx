    ...
    <section id="Hero" className="w-full">
        ...
        <div class=" flex   flex-col-reverse mx-auto  p-6 lg:flex-row bg-blue-200 w-full">
            ...
            <div class="flex flex-col space-y-10 mb-44 lg:mt-16 lg:w-1/2 xl:mb-52 ">
                <h1 class="text-5xl font-bold text-center lg:text-6xl lg:max-w-md lg:text-left capitalize">
                ...
                <div class="mx-auto lg:mx-0">
                    <a href="" class="px-10 py-5 font-bold text-2xl text-white bg-black rounded-full lg:py-4 hover:opacity-70">
                        Get Started
                    </a>
                </div>
            </div>
