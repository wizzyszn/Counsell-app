    ...
    <div className="flex justify-center items-center min-h-screen bg-rose-50">
        ...
        <div className="relative flex flex-col m-6 space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 md:m-0 w-full">
            ...
            <div className="p-6 md:p-20 mx-auto w-[752px]">
                {/* <!-- Top content --> */}
                <h2 className="mb-5 text-4xl font-bold text-cyan-700">Sign up</h2>
                <p className="max-w-sm mb-12 text-2xl font-bold text-cyan-700">Create an account
                </p>
                ...
                <input type="text" className="py-4 px-6 w-full border border-gray-400 rounded-md mb-4"placeholder="Enter your Mat No"/>
                
                <input type="text" className="py-4 px-6 w-full border border-gray-400 rounded-md mb-4"placeholder="Enter your Email address"/>


                {/* <!-- middle content --> */}
                <div className="flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-6">
                    {/* <!-- <div class="font-thin text-cyan-700"> <a href="#">Forgot Password</a> </div> --> */}

                    <button className="w-full flex justify-center items-center p-6 space-x-4 font-bold text-white rounded-md px-9 bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 shadow-sm hover:shadow-lg border transition hover:-translate-y-0.5 duration-200">
                        <span>Sign up</span>
                    </button>
                </div>
                ...
                {/* <!-- buttom content --> */}
                <p className="py-6 text-sm text-center text-gray-400 font-thin">or sign up with</p>
